...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            if self.epsilon > random.random():
                ...
                action_list=[key for key,value in (self.Q[state]).iteritems() if self.get_maxQ(state) == value] 
    ...
    def learn(self, state, action, reward):
        ...
        #   Use only the learning rate 'alpha' (do not use the discount factor 'gamma')self.alpha
